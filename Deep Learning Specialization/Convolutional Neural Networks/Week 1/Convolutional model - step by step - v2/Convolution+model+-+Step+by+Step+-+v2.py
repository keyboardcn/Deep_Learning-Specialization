            ...
            for w in range(n_W):               # loop on the horizontal axis
                for c in range(n_C):           # loop over the channels (depth)
                    ...
                    if mode == "max":
                        ...
                        dA_prev[i, vert_start: vert_end, horiz_start: horiz_end, :] += np.multiply(mask,dA[i,h,w,c])
                        ...
                        dA_prev[i, vert_start: vert_end, horiz_start: horiz_end, :] += distribute_value(da,shape)
